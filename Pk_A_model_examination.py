...
if __name__ == '__main__':
    ...
    antisym_func.mkdir('/scratch/liuzhaoning/antisym_observability/Pk_A_model_examination')
    ...
    DIR_load = '/scratch/liuzhaoning/antisym_observability/Pk_A_model_examination/zeta%05.5g_Tvir%05.5g_Rmfp%05.5g_SMO%03.3g'%(zeta, T_vir, R_mfp, SMOOTHING_SCALE)
    ...
    #set the redshift of antisymmetric power spectrum we are computating(dxHdz determined by the Zhou's simulation)
    dxHdz_xi_acc_smoothed_array = [0.222, 0.238, 0.246, 0.255, 0.271, 0.288, 0.304, 0.312, 0.321, 0.337, 0.354, 0.371, 0.378]
    dxHdz_xi_dec_smoothed_array = [0.378, 0.362, 0.345, 0.329, 0.312, 0.296, 0.279, 0.263, 0.246]
    z_xi_acc_smoothed_array = []; z_xi_dec_smoothed_array = [];
    for dxHdz in dxHdz_xi_acc_smoothed_array:
        z_xi_acc_smoothed_array.append(antisym_func.dxHdz_To_z(dxHdz, M_max, zeta_z_func, T_vir, mu, z_dxHdz_history, dxHdz_history)[1])
    for dxHdz in dxHdz_xi_dec_smoothed_array:
