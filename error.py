...
def slope_fitting(kh_array, Pk_A_array, error_bar = [0]):
    ...
    if error_bar[0] == 0:
        ...
        popt, pocv = curve_fit(LS_PowerLaw_factor, kh_array, Pk_A_array, sigma = error_bar, absolute_sigma=True, p0 = [Pk_A_array[-1],2])
    return [popt[0], popt[1], pocv] #[A_R, n_R, covariance matrix]
